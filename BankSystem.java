...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			if (b == false) {
				BankHelp hlpBank = new BankHelp ("BankSystem Help", "key.txt");
				desktop.add (hlpBank);
				hlpBank.show ();
			}
			...
			if (b == false) {
				BankHelp hlpKey = new BankHelp ("BankSystem Keys", "Key.txt");
				desktop.add (hlpKey);
				hlpKey.show ();
			}
			...
			String msg = "BankSystem\n\n" + "Created & Designed By:\n" + 
				"Dinesh\nDivya\nSandeep\nNandini\nVenkat sai\n\n" + "E-mail:\n banaladineshreddy@gmail.com\nndivyachitukula@gmail.com\nsandeepjangamgari@gmail.com\nnandinipogula@gmail.com\ngunduvenkatasai@gmail.com";
